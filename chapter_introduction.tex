...
The combination of different cosmological probes leads to more accurate measurements at the same time it breaks degeneracies on the determination of the cosmological parameters \cite{2006A&A...448..831Y,Weinberg201387}. Nevertheless, multiprobe constrains suffer from the correlation of the different methodologies. In addition, if the different probes are provided by the same experiment, they must also take into account the correlation of the different sources of systematic errors \cite{2016arXiv160105779K,2016arXiv160701761S,2017MNRAS.465L..20S,2017arXiv170307786F}.  Thus, the inclusion of an specific measurement on a multiprobe analysis, that is highly correlated with other probes or is very noisy, may no lead to a significant improvement of the cosmological constrain.
\newline
...
This implies that the direct determination of the matter profile of voids by weak-lensing magnification, constitutes a promising and independent new probe on dark energy, alternative to multiprobe constrains.
