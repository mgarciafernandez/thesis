...
\documentclass[12pt,draft]{book} % Default font size
...
\AddToShipoutPicture*{\put(0,0){\includegraphics[height=23cm,angle=90,trim=4cm 2cm 0 0,clip]{ds9.png}}\put(100,0){\includegraphics[width=\textwidth,angle=0,clip]{MDM_Banner.jpg}}} % Image background

\centering
\vspace*{5cm}
\par\normalfont\fontsize{27}{27}\sffamily\selectfont
\textcolor{red}{\textbf{Weak-lensing magnification as a probe for the dark Universe}}\par % Book title
\vspace*{1cm}
\textcolor{red}{\textbf{\Huge Manuel Garc\'ia Fern\'andez}}\par % Author name
