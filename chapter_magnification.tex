...
Measured convergence profiles can be seen at \autoref{fig:troughs_ap10},

\begin{sidewaysfigure}
\includegraphics[width=\textwidth]{./figures_y1/troughs_ap10_mag_auto_i1.png}
\caption{Convergence profile for the DES-Y1 $10'$ troughs. The $Q=0,1,2,3,4$ indicates the quantile of the lognormal distribution that is probed. Green-solid line is the size of the trough. Red-dashed line is an eye-guide for the zero.}
